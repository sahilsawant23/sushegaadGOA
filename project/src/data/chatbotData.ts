...
export const quickReplies: QuickReply[] = [
  ...
  { id: 'beaches', text: '🏖️ Explore Beaches', action: 'show_beaches' },
  { id: 'nightlife', text: '🌙 Nightlife Guide', action: 'show_nightlife' },
  { id: 'help', text: '❓ Need Help', action: 'show_help' },
];

export const tourCategories = [
  { id: 'beach', text: '🏖️ Beach Tours', action: 'filter_tours_beach' },
  { id: 'heritage', text: '🏛️ Heritage Tours', action: 'filter_tours_heritage' },
  ...
  { id: 'food', text: '🍽️ Food Tours', action: 'filter_tours_food' },
];

export const beachRegions = [
  { id: 'north', text: '🌊 North Goa Beaches', action: 'show_north_beaches' },
  { id: 'south', text: '🏝️ South Goa Beaches', action: 'show_south_beaches' },
...
export const chatbotResponses = {
  ...
  beaches: {
    general: "🏖️ Goa has 40+ stunning beaches! Which region would you like to explore?",
  ...
  booking_intent: "Great! I can help you book a tour. Let me redirect you to our booking page where you can select dates and complete your reservation.",
